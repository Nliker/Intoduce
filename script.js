...
let modalItem = document.querySelectorAll(".mac_modal");
...
const onClickMenuItem = (e) => {
    ...
    const currentNumber = liTag.classList[0].slice(-1);
    const selectedModal = document.querySelector(`#mac_modal${currentNumber}`);
